...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
        ...
        new_filename = in_files[idx]

        #  Convert new_filename to lower case and split it by '_'
        word_list = new_filename.lower().split('_')

        # Create pet label by joining all words that are alphabetic
